...
const About = () => {
  const paragraphs = [
    "Hi, I'm Clint, a web developer and recent graduate of Lighthouse Labs' Web Development Bootcamp. My portfolio showcases projects that highlight my ability to create interactive, user-friendly, and responsive web applications using modern development practices. I work with a diverse set of technologies—including React, JavaScript, Node.js, Express, Ruby on Rails, jQuery, SQL, and Python—which empower me to build robust and scalable digital solutions.",
